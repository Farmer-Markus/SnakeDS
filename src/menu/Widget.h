...
public:
    ...
    // Event handlers
    virtual bool MsgKeyDown(const KeyState) { return false; }
    virtual bool MsgKeyUp(const KeyState) { return false; }
    ...
    virtual inline Widget& SetFocus(const bool focus);
    ...
    virtual inline bool IsFocused() const;
...
inline Widget& Widget::SetFocus(const bool focus)
{
    m_focus = focus;
    return *this;
}
